...
class LiveWeatherServiceTest {
    ...
    @Test
    void throws_exception_on_invalid_weather_api_response() {
        // Given
        liveWeatherService = new LiveWeatherService(
            new RestTemplateBuilder().rootUri("http://localhost:8090").build(),
            new ObjectMapper()
        ...
        wireMockServer.stubFor(WireMock.get("/data/2.5/weather?q=Vilnius&appid=apiKey&units=metric")
            .willReturn(aResponse()
                .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                .withStatus(200)
                .withBody("{\"coord\":{\"lon\":25.2798,\"lat\":54.6892},\"weather\":[{\"id\":800,\"important\":\"Clear\",\"description\":" +
        ...
        // When, Then
        assertThrows(WeatherResponseParsingException.class, () -> liveWeatherService.getCurrentWeather("Vilnius"));
    }
